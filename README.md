...
Training pipeline for large image datasets

Image-based prediction interface for model outputs
...
Place your dataset in the expected directory structure.

Run the preprocessing script to clean and augment the images.
